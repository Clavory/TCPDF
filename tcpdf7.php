...
$patch_array[0]['points'] = array(
    ...
    0.00,0.33);
$patch_array[0]['colors'][0] = array('r' => 255, 'g' => 255, 'b' => 255);
$patch_array[0]['colors'][1] = array('r' => 0, 'g' => 0, 'b' => 0);
$patch_array[0]['colors'][2] = array('r' => 255, 'g' => 255,'b' => 255);
$patch_array[0]['colors'][3] = array('r' => 0, 'g' => 0,'b' => 0);
...
$patch_array[2]['points'] = array(
    ...
    1.33,2.00);
$patch_array[2]['colors'][0] = array('r' => 255, 'g' => 255, 'b' => 255);
...
$patch_array[3]['colors'][1] = array('r' => 255, 'g' => 255, 'b' => 255);
...
$pdf->Cell(0, 0, 'Greetings from Allapitan from BSIT-3!', 1, 1, 'C', 0, '', 2);
